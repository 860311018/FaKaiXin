...
@property (nonatomic) NSLayoutConstraint *typeWithTitleLeftConstraint;

@property (nonatomic) NSLayoutConstraint *typeWithoutTitleLeftConstraint;
...
//    _typeLabel = [[UIButton alloc] init];
//    _typeLabel.hidden = YES;
//    _typeLabel.titleLabel.font = [UIFont systemFontOfSize:12];
...
- (void)setModel:(id<IConversationModel>)model
{
    ...
    CGRect frameType = _typeLabel.frame;
    CGRect frameTitle = _titleLabel.frame;
    frameType.origin.x = CGRectGetMaxX(frameTitle) + 8;
    frameType.origin.y = CGRectGetMinY(frameTitle) + 2;
    _typeLabel.frame = frameType;
