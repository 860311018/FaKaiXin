...
@interface FKXMyDynamicWithTextCell ()
...
@implementation FKXMyDynamicWithTextCell

- (void)awakeFromNib {
    [super awakeFromNib];
    // Initialization code
    _detailText.textContainerInset = UIEdgeInsetsMake(15, 10, 15, 10);
...
-(void)setModel:(MyDynamicModel *)model
{
    ...
    _contextLab.text = model.commentText;
